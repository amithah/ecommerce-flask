...
Revision ID: acb69d5a437b
Revises: e0623781ff6c
Create Date: 2020-06-08 16:04:16.520135
...
revision = 'acb69d5a437b'
down_revision = 'e0623781ff6c'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.UniqueConstraint('slug', name='product_slug_key')
    )
